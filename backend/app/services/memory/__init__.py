...
This module provides a pure Python sqlite3-based solution using FTS5
for full-text search. It's lighter weight than vector databases, has no 
external dependencies beyond the Python standard library, and is well-suited 
for local-first desktop apps.

Replaces the previous LanceDB-based implementation.
"""
...
VALID_MEMORY_TYPES = frozenset({
    "decision", "pattern", "context", "learning", "note",
...
HybridMemoryService = LocalMemoryService
...
__all__ = [
    ...
    "FileStore",
    "LocalMemoryService",
    "HybridMemoryService",  # Backwards compatibility
    "get_memory_service",
    "VALID_MEMORY_TYPES",
]
